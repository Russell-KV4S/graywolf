...
- [`notifications.md`](notifications.md) -- clickable new-message/new-bulletin popup notifications: unread-badge push-vs-poll fix, the toast/OS/both notification mode, the shared bulletins store, and the `#/bulletins?focus=<id>` deep-link.
